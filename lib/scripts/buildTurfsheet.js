...
(async () => {
    for (let sheet of spritesheetFiles) {
        ...
        ctx.drawImage(img, 24, 24, 24, 24, 24, 24, 24, 24);
        ctx.drawImage(img, 0, 0, 24, 24, 48, 24, 24, 24);
        ctx.drawImage(img, 24, 24, 24, 24, 72, 24, 24, 24);
        ctx.drawImage(img, 0, 0, 24, 24, 96, 24, 24, 24);
        ctx.drawImage(img, 24, 24, 24, 24, 120, 24, 24, 24);
        ctx.drawImage(img, 24, 24, 24, 24, 144, 24, 24, 24);
        ctx.drawImage(img, 0, 0, 24, 24, 168, 24, 24, 24);
        ...
        ctx.drawImage(img, 0, 0, 24, 24, -73, 48, 24, 24);
        ctx.drawImage(img, 24, 24, 24, 24, -97, 48, 24, 24);
        ctx.drawImage(img, 0, 0, 24, 24, -121, 48, 24, 24);
        ctx.drawImage(img, 24, 24, 24, 24, -145, 48, 24, 24);
        ctx.drawImage(img, 0, 0, 24, 24, -169, 48, 24, 24);
        ctx.drawImage(img, 24, 24, 24, 24, -193, 48, 24, 24);
        ctx.restore();
